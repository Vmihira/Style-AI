...
export default function ResultPage() {
  ...
  const generateStyleImage = async (items: FashionItem[]) => {
    try {
      ...
      if (data.success && data.image_data) {
        ...
        if (data.image_data.base64 && data.image_data.base64.length > 0) {
          console.log("Setting generated image data...")
          console.log("Base64 length:", data.image_data.base64.length)
          console.log("MIME type:", data.image_data.mime_type)
          ...
          setError("Generated image data is empty or invalid.")
  ...
  const handleDownload = () => {
    if (generatedImageData && generatedImageData.base64) {
      try {
        ...
        link.download = generatedImageData.filename || `ai-style-${Date.now()}.png`
  ...
  // Create the image source URL from base64 data
  const getImageSrc = () => {
    if (generatedImageData && generatedImageData.base64) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-50">
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        {process.env.NODE_ENV === "development" && generatedImageData && (
          <div className="mb-8 bg-gray-100 border border-gray-300 text-gray-700 px-4 py-3 rounded-lg text-sm">
            <strong>Debug Info:</strong>
            <br />
            Image ID: {generatedImageData.image_id}
            <br />
            Filename: {generatedImageData.filename}
            <br />
            MIME Type: {generatedImageData.mime_type}
            <br />
            ...
            <br />
            Generation Status: {isGenerating ? "Generating..." : "Complete"}
          </div>
        )}
        ...
        {!isGenerating && !error && generatedImageData && imageLoaded && styleAnalysis && (
